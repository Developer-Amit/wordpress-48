...
if (!class_exists('g5plusFramework_Shortcode_Google_Map')) {
	class g5plusFramework_Shortcode_Google_Map{
		...
		function google_map($atts) {
			$location_x = $location_y = $layout_style=$api_url=$marker_title=$marker_icon=$info_html=$info_max_width=$info_bg=$info_color=$map_height=$map_zoom=$map_style=$el_class=$css_animation=$duration=$delay='';
			...
			wp_enqueue_script('megatron-google-api',$api_url, array(), false, true);
