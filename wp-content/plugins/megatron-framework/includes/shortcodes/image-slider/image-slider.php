...
if (!class_exists('g5plusFramework_ShortCode_Image_Slider')) {
    class g5plusFramework_ShortCode_Image_Slider
    {
        ...
        function image_slider_shortcode($atts)
        {
            ...
            $data_carousel = '"autoplay": '.$autoplay.',"loop":false,"center":false,"autoplayHoverPause":'.$autoplayhoverpause.',"autoplayTimeout":'.$autoplaytimeout.', "items":1,"responsive":{},"dots":' . $dots . ', "nav":' . $nav;
