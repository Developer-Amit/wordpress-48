...
<div
    ...
    <div class="portfolio-tabs <?php echo esc_attr($css_category) ?> <?php if($show_category!=''){ echo 'category ';} if(isset($show_title) && $show_title == 'yes'){ echo ' title';} ?>">
        ...
        if ($show_category != '') {
            $termIds = array();
            $portfolio_terms = get_categories(array('taxonomy' => G5PLUS_PORTFOLIO_CATEGORY_TAXONOMY ));
            if ($category != '') {
            ...
            if($is_archive){
                ...
                $terms = get_categories(array('taxonomy' => G5PLUS_PORTFOLIO_CATEGORY_TAXONOMY, 'include' => $termIds  ));
            }
