...
?>
<div class="portfolio-full detail-01 video-slider-wrap" id="content">
    <div class="fullwidth">
        <div class="container">
            <div class="navigator">
                <?php
                        ...
                        if(isset($videos) && is_array($videos) && count($videos['portfolio_video_fields'])>0){
                            ...
                            for($i=0; $i<count($videos['portfolio_video_fields']);$i++){
                                ...
                                <div class="item">
                                    ...
                                    <div class="overlay-video" data-index="<?php echo esc_attr($index++) ?>" >
    ...
    (function($) {
        ...
        $(window).load(function(){
            ...
            function movePostSlide(index){
                if(index!='undefined'){
                    $portfolio_owl.trigger('to.owl.carousel',[index, 200, true]);

                }
            }

            $('.slideshow-paging .item .overlay-video').click(function(){
                var $index = $(this).attr('data-index');
                movePostSlide($index);
            });
        })
