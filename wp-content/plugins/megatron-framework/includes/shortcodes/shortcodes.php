    ...
    class g5plusFramework_Shortcodes
    {
        ...
        public function register_vc_map()
        {
            ...
            if (function_exists('vc_map')) {
                ...
                if (!isset($cpt_disable) || (array_key_exists('portfolio', $cpt_disable) && ($cpt_disable['portfolio'] == '0' || $cpt_disable['portfolio'] == ''))) {
                    $portfolio_categories = get_categories(array('hide_empty' => 0, 'orderby' => 'ASC','taxonomy' => G5PLUS_PORTFOLIO_CATEGORY_TAXONOMY));
                    $portfolio_cat = array();
                ...
                if (!isset($cpt_disable) || (array_key_exists('ourteam', $cpt_disable) && ($cpt_disable['ourteam'] == '0' || $cpt_disable['ourteam'] == ''))) {
                    $ourteam_cat = array();
                    $ourteam_categories = get_categories(array('hide_empty' => 0, 'orderby' => 'ASC','taxonomy' => 'ourteam_category'));
                ...
                vc_map(
                    array(
                        ...
                        'params' => array(
                            ...
                            array(
                                'type' => 'textfield',
                                'heading' => esc_html__('API Url', 'g5plus-megatron'),
                                'param_name' => 'api_url',
